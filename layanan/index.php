...
<body>
    <div class="container">
        <h6 class="border-bottom pb-2 mb-0">Aplikasi BPKAD</h6>
        <?php
        include 'koneksi.php';
        ...
        ?>
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                <div class="d-flex text-muted pt-3">
                    <img src="file/<?= $row['foto_siswa']; ?>" class="bd-placeholder-img flex-shrink-0 me-2 rounded" width="15%" height="15%" alt="...">
